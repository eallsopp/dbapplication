...
class DatabasePersistence
  def initialize(logger)
    @db = if Sinatra::Base.production?
            PG.connect(ENV['postgres://pvtzmsdijepspa:3252cfb84475104c66afaaafa085b493aeebd764f3f3bf5cddd9caafe9a8ca80@ec2-35-168-77-215.compute-1.amazonaws.com:5432/d7sud06qsmgap9'])
          else
  ...
  def delete_todo_list(id)
    query("DELETE FROM todos WHERE lists_id = $1", id)
  ...
  def create_new_todo(list_id, todo_name)
    sql = "INSERT INTO todos (name, lists_id) VALUES ($1, $2)"
    query(sql, todo_name, list_id)
  end

  def delete_todo_from_list(list_id, todo_id)
    sql = "DELETE FROM todos WHERE id = $1 AND lists_id = $2"
